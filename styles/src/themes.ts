...
export const CONTRAST: Theme = {
  ...
  tunnel_highway_casing: "#DD8E8E",
  tunnel_other: "white",
  tunnel_minor: "#ebebeb",
  tunnel_link: "#ebebeb",
  tunnel_medium: "#ebebeb",
  tunnel_major: "#ebebeb",
  tunnel_highway: "#F5AFAF",
  ...
  minor_casing: "#DFDCD2",
  link_casing: "#DFDCD2",
  medium_casing: "#E9E5DA",
  major_casing_late: "#BBB4A1",
  highway_casing_late: "#D47777",
  other: "#ffffff",
...
export const CONTRAST_DARKMODE : Theme = {
  ...
  tunnel_highway_casing: "#273A4F",
  tunnel_other: "#2D343C",
  tunnel_minor: "#2D343C",
  tunnel_link: "#2D343C",
  tunnel_medium: "#2D343C",
  tunnel_major: "#2D343C",
  tunnel_highway: "#2D343C",

  transit_pier: "#333333",
  buildings: "#202932",

  minor_service_casing: "#2D343C",
  minor_casing: "#2D343C",
  link_casing: "#2D343C",
  medium_casing: "#2D343C",
  major_casing_late: "#2D343C",
  highway_casing_late: "#73869B",
  other: "#4B5A69",
  minor_service: "#4B5A69",
  minor_a: "#4B5A69",
  minor_b: "#4B5A69",
  link: "#4B5A69",
  medium: "#4B5A69",
  ...
  roads_label_minor: "#C1DAE4",
  roads_label_minor_halo: "#1f1f1f",
  roads_label_major: "#C1DAE4",
  roads_label_major_halo: "#1f1f1f",
  ocean_label: "#5785BB",
  peak_label: "#C1DAE4",
  subplace_label: "#C1DAE4",
