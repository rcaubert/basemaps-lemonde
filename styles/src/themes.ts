...
export const CONTRAST: Theme = {
  ...
  tunnel_major_casing: "#BBB4A1",
  tunnel_highway_casing: "#7C796F",
  tunnel_other: "white",
  tunnel_minor: "#ebebeb",
  tunnel_link: "#ebebeb",
  tunnel_medium: "#ebebeb",
  tunnel_major: "#ebebeb",
  tunnel_highway: "#9E9B91",
  ...
  minor_casing: "#DFDCD2",
  link_casing: "#DFDCD2",
  medium_casing: "#ACA799",
  major_casing_late: "#BBB4A1",
  highway_casing_late: "#7C796F",
  other: "#ffffff",
  ...
  link: "#E8E6E1",
  medium: "#D5CEBF",
  major_casing_early: "#BBB4A1",
  major: "#D8D0BE",
  highway_casing_early: "#9E9B91",
  highway: "#9E9B91",
  ...
  bridges_major_casing: "#BBB4A1",
  bridges_highway_casing: "#7C796F",
  bridges_other: "#ffffff",
  bridges_minor: "#ffffff",
  bridges_link: "#e1e1e1",
  bridges_medium: "#ffffff",
  bridges_major: "#BBB4A1",
  bridges_highway: "#9E9B91",
