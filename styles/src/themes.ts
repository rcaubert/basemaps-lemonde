...
export const CONTRAST: Theme = {
  ...
  park_a: "#C0CA9A",
  park_b: "#C0CA9A",
  hospital: "#E8E6E1",//"#F4E0DA",
  industrial: "#E8E6E1",//"#d6d0c440",
  school: "#E8E6E1",//"#FFE7C2",
  wood_a: "#bfc99c",
  wood_b: "#bfc99c",
  pedestrian: "#E1DCD0",
  scrub_a: "#BCC795",
  ...
  tunnel_other_casing: "#DFDCD2",
  tunnel_minor_casing: "#DFDCD2",
  tunnel_link_casing: "#DFDCD2",
  tunnel_medium_casing: "#DFDCD2",
  tunnel_major_casing: "#DFDCD2",
  tunnel_highway_casing: "#DFDCD2",
  tunnel_other: "#ffffff",
  tunnel_minor: "#ffffff",
  tunnel_link: "#ffffff",
  ...
  minor_service_casing: "#DFDCD2",
  minor_casing: "#DFDCD2",
  link_casing: "#DFDCD2",
  medium_casing: "#DFDCD2",
  major_casing_late: "#DFDCD2",
  highway_casing_late: "#DFDCD2",
  other: "#ffffff",
  ...
  link: "#ffffff",
  medium: "#ffffff",
  major_casing_early: "#DFDCD2",
  major: "#ffffff",
  highway_casing_early: "#DFDCD2",
  highway: "#ffffff",

  railway: "#78878F",
  boundaries: "#5c4a6b80",
  waterway_label: "#758B95",

  bridges_other_casing: "#DFDCD2",
  bridges_minor_casing: "#DFDCD2",
  bridges_link_casing: "#DFDCD2",
  bridges_medium_casing: "#DFDCD2",
  bridges_major_casing: "#DFDCD2",
  bridges_highway_casing: "#DFDCD2",
  ...
  roads_label_major: "#59564B",
  roads_label_major_halo: "#E8E6E1",
  ocean_label: "#758B95",
  peak_label: "#718156",
  subplace_label: "#59564B",
  subplace_label_halo: "#F7F5EF",
  city_circle: "#666666",
  city_circle_stroke: "#F7F5EF",
  city_label: "#59564B",
  city_label_halo: "#F7F5EF",
  state_label: "#59564B",
  state_label_halo: "#F7F5EF",
  country_label: "#9590aa",
};

export const CONTRAST_DARKMODE : Theme = {
  background: "#34373d",
  earth: "#39434C",
  park_a: "#365C5A",
  park_b: "#365C5A",
  hospital: "#39434C", //"#51343B"
  industrial: "#374149",
  school: "#39434C", //"#514034"
  wood_a: "#2C514F",
  wood_b: "#2C514F",
  pedestrian: "#404B55",
  scrub_a: "#517472",
  ...
  tunnel_other_casing: "#273A4F",
  tunnel_minor_casing: "#273A4F",
  tunnel_link_casing: "#273A4F",
  tunnel_medium_casing: "#273A4F",
  tunnel_major_casing: "#273A4F",
  tunnel_highway_casing: "#303438",
  tunnel_other: "#2D343C",
  tunnel_minor: "#2D343C",
  tunnel_link: "#2D343C",
  tunnel_medium: "#2D343C",
  tunnel_major: "#2D343C",
  tunnel_highway: "#4B545D",

  transit_pier: "#333333",
  buildings: "#202932",

  minor_service_casing: "#22272C",
  minor_casing: "#22272C",
  link_casing: "#515B65",
  medium_casing: "#2D343C",
  major_casing_late: "#2D343C",
  highway_casing_late: "#303438",
  other: "#404A54",
  minor_service: "#404A54",
  minor_a: "#404A54",
  minor_b: "#404A54",
  link: "#515B65",
  medium: "#515B65",
  major_casing_early: "#2D343C",
  major: "#65717C",
  highway_casing_early: "#303438",
  highway: "#74818D",
  ...
  bridges_other_casing: "#414B56",
  bridges_minor_casing: "#414B56",
  bridges_link_casing: "#414B56",
  bridges_medium_casing: "#414B56",
  bridges_major_casing: "#414B56",
  bridges_highway_casing: "#414B56",
  bridges_other: "#525E6C",
  bridges_minor: "#525E6C",
  bridges_link: "#525E6C",
  bridges_medium: "#525E6C",
  bridges_major: "#525E6C",
  bridges_highway: "#525E6C",

  roads_label_minor: "#BAC4C7",
  roads_label_minor_halo: "#1f1f1f",
  roads_label_major: "#D4DFE4",
  roads_label_major_halo: "#1f1f1f",
  ocean_label: "#5785BB",
  peak_label: "#D4DFE4",
  subplace_label: "#D4DFE4",
...
const themes: Record<string, Theme> = {
  ...
  black: BLACK,
  contrast: CONTRAST,
  contrast_darkmode: CONTRAST_DARKMODE,
};
